...
CONFIG.CONST_WIDTH {16} \
  ...
  connect_bd_net -net FCSMPC_0_GH_V_ap_vld [get_bd_pins FCSMPC_0/GH_V_ap_vld] [get_bd_pins SOH3_1/Valid]
  ...
  connect_bd_net -net FCSMPC_0_id_exp [get_bd_pins FCSMPC_0/id_exp]
  connect_bd_net -net FCSMPC_0_iq_exp [get_bd_pins FCSMPC_0/iq_exp]
  ...
  connect_bd_net -net xlslice_1_Dout [get_bd_pins AXI_to_Signal_0/Signal_15_0] [get_bd_pins FCSMPC_0/id_m]
  connect_bd_net -net xlslice_2_Dout [get_bd_pins AXI_to_Signal_0/Signal_31_16] [get_bd_pins FCSMPC_0/iq_m]
...
CONFIG.IS_ACLK_ASYNC {0} \
  ...
  set axis_encoder_0 [ create_bd_cell -type ip -vlnv trenz.biz:user:axis_encoder_3600:1.1 axis_encoder_0 ]
  set_property -dict [ list \
...
connect_bd_intf_net -intf_net Conn7 [get_bd_intf_pins FOC/V_alphabeta_m] [get_bd_intf_pins axis_monitor_0/s05_axis]
  ...
  connect_bd_net -net Debounce_0_DBx [get_bd_pins Debounce_0/DBx] [get_bd_pins my_2_3MUX_0/SEL] [get_bd_pins xlconcat_2/In0]
