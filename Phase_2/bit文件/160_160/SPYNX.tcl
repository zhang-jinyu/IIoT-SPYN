...
proc create_hier_cell_FCSMPC { parentCell nameHier } {
  ...
  create_bd_pin -dir O -from 15 -to 0 Signal_47_32
  ...
  set FCSMPC_0 [ create_bd_cell -type ip -vlnv TUM_EAL:hls:FCSMPC:3.4 FCSMPC_0 ]
...
CONFIG.CONST_WIDTH {16} \
  ...
  # Create port connections
  connect_bd_net -net AXI_to_Signal_0_Valid [get_bd_pins Valid] [get_bd_pins AXI_to_Signal_0/Valid] [get_bd_pins MPC_Trigger_v1_0_0/AXI_data_valid]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXI_to_Signal_0_Valid]
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net P_Controller_0_RPM [get_bd_pins Signal_47_32] [get_bd_pins AXI_to_Signal_0/Signal_47_32] [get_bd_pins FCSMPC_0/RPM]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets P_Controller_0_RPM]
...
CONFIG.C_DECIMATION {0} \
CONFIG.C_IMPLEMENTATION {1} \
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net FCSMPC_Signal_47_32 [get_bd_pins FCSMPC/Signal_47_32] [get_bd_pins system_ila_0/probe8]
  connect_bd_net -net FCSMPC_Valid [get_bd_pins FCSMPC/Valid] [get_bd_pins system_ila_0/probe10]
  ...
  connect_bd_net -net axis_encoder_0_angle_data [get_bd_pins Angle_concat/In0] [get_bd_pins FCSMPC/angle] [get_bd_pins axis_encoder_0/angle_data] [get_bd_pins system_ila_0/probe9]
