...
```
  ...
  ## 2.3 项目总结
  能够参加xilinx中国举办的这次冬令营活动我感到非常荣幸。在这次冬令营活动中，我系统学习了基于HLS的加速原理、vivado hls的使用以及较为全面的学习了最新的VITIS开发工具。除此之外，我还在这次活动中听到各位学者、研究员和同学分享的前沿技术及优秀项目。并通过模型预测控制算法这个项目对所学知识进行检查和巩固